  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-50 via-white to-emerald-50 flex items-center justify-center px-4 py-10 relative overflow-hidden">
      ...
      <div className="relative w-full max-w-md z-10">
        <div className="absolute -top-4 left-2 sm:-left-2 bg-white border border-green-100 rounded-xl px-3 py-1.5 text-xs font-semibold text-green-700 flex items-center gap-2 shadow-sm">
